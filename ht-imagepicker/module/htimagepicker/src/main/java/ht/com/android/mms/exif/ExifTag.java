...
public class ExifTag {
     ...
     *               is greater than component count, only the valid bytes will be stored.
     * @exception IllegalArgumentException If the type is NOT
     *                {@link #TYPE_UNDEFINED} or {@link #TYPE_UNSIGNED_BYTE}.
     */
    ...
    /**
     * Gets the offset of this tag. This is only valid if this data size greater than 4 and
