...
import ht.com.android.mms.exif.ExifInterface;

public class ImageCleanupTask extends Thread {
    private static final String TAG = "ImageCleanupTask";
    private byte[] data;
...
//                    original = BitmapFactory.decodeByteArray(data, 0, data.length, opts);
//
//                    cleaned = Bitmap.createBitmap(original, 0, 0, original.getWidth(),
